...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    console.log(data);
    // 3. Create variable that holding samples array. 
    var buttonSamples = data.samples;
    // 4. Create a variable that filters samples for the object w/ desired sample number.
...
var trace = {
 ...
 // 1. Create trace for the bubble chart.
 var bubbleTrace = {
    x: sampleIds,
    y: sampleValues,
    text:sampleLabels,
